...
export default async (request, context) => {
  ...
  // Works in ALL browsers including Telegram's built-in WebView.
  // On Android/iOS the OS will natively prompt "Open in Amazon app?" - no intent hacks needed.
  // Previous bridge HTML with intent schemes was silently failing in WebView causing 0% conversions.
  return new Response(null, {
    status: 302,
    headers: {
